    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6">
          <Link href='/' className="hover:text-[#2A9D8F] transition-colors flex items-center dark:text-white">
            <Home size={16} className="mr-1" /> Home
          </Link>
          <a href="#mission" className="hover:text-[#2A9D8F] transition-colors flex items-center dark:text-white">
            <Info size={16} className="mr-1" /> Mission
          </a>
          <a href="#team" className="hover:text-[#2A9D8F] transition-colors flex items-center dark:text-white">
            <Users size={16} className="mr-1" /> Our Team
          </a>
          <a href="#contact" className="hover:text-[#2A9D8F] transition-colors flex items-center dark:text-white">
