    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:flex space-x-6">
          ...
          <Link href="#roi-calculator" className="hover:text-[#2A9D8F] transition-colors flex items-center dark:text-white">
            <Calendar size={16} className="mr-1" /> ROI Calculator
          </Link>
          <Link href="#testimonials" className="hover:text-[#2A9D8F] transition-colors flex items-center dark:text-white">
            <Users size={16} className="mr-1" /> Testimonials
          </Link>
          <Link href="/about" className="hover:text-[#2A9D8F] transition-colors flex items-center dark:text-white">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link href="/institution/login" className="px-4 py-2 rounded-md bg-[#1D3557] text-white hover:bg-opacity-90 transition-colors hover:bg-[#2A9D8F]">
            Sign In
          </Link>
