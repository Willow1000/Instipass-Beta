...
const InstitutionDetailsForm = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.web_url && !/^(https?:\/\/)?([\da-z.-]+)\.([a-z.]{2,6})([/\w .-]*)*\/?$/.test(formData.web_url)) {
      errors.web_url = 'Website URL is invalid';
    }
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (response.status === 400) {
            ...
            throw new Error('if you are seeing this error it means you are already registered.\n if not kindly contact support'.toUpperCase());
