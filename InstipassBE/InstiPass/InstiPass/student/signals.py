...
def send_application_received_email(instance):
    ...
    send_mail(
        subject="We have received your application. Hang tight as we work on it",
...
def send_application_updated_email(instance):
    ...
    # Send email with both HTML and plain text versions
    send_mail(
        subject="Your application has been updated successfully",
        message=plain_message,
        from_email="admin@django.com",
        recipient_list=[instance.email],
        fail_silently=False,
...
def application_received(sender, instance, created, **kwargs):
    if created:
        ...
        from yourapp.models import IdOnQueue, IdprogressLog
